...
#Saving the examples as variables
...
def prepare_text(text):
    ...
    text1 = text.lower()
    text2 = text1.replace("?", "").replace("!", "").replace(".", "").replace(",", "").replace('"', "").replace("'", "")
    words = text2.split(" ")
...
class TextSample:
    ...
    def __repr__(self):
        ...
        return "{author}'s average sentence length is: {average_sentence_length}".format(author = self.author, average_sentence_length = self.average_sentence_length)
...
def find_text_similarity(sample1, sample2):
    ...
    table1 = sample1.word_count_frequency
    table2 = sample2.word_count_frequency
    word_count_similarity = frequency_comparison(table1, table2)

    tableone = sample1.ngram_frequency
    tabletwo = sample2.ngram_frequency
    ngram_similarity =  frequency_comparison(tableone, tabletwo)
...
print("Lily Trebuchet's similarity score to the murder letter is:", find_text_similarity(lily_sample, murderer_sample))
print("Gregg T Fishy's similarity score to the murder letter is:", find_text_similarity(gregg_sample, murderer_sample))
print("Myrtle Beech's similarity score to the murder letter is:", find_text_similarity(myrtle_sample, murderer_sample))



#Who dunnit?
print("The murderer is Lily Trebuchet!")
